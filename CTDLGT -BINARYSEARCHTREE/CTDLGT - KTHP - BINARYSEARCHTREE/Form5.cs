...
namespace CTDLGT___KTHP___BINARYSEARCHTREE
{
    public partial class Form5 : Form
    {
        ...
        public void btnFindName_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (cbbP2Dose.Text == "Mũi 1")
                {
                    ...
                    if (CheckVaccine(cbbP2ID.Text, cbbP2VaccineName.Text))
                    {
                        ...
                        {
                            Record newrecord = new Record(id, txbP2Name.Text, txbP2Address.Text, dtpP2Birthday.Value.Date, cbbP2Gender.Text, newinjection);
